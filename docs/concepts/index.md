...
-   **:stopwatch: Real-time Monitoring**
    ...
    [Read more](real-time-monitoring.md)

-   **:bar_chart: Compact vs Native Data Formats**

    ---

    Trade-offs between representation styles and when each one fits best.

    [Read more](compact-vs-native-data.md)
